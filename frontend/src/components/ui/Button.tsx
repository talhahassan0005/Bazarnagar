...
/** Inline spinner shown in place of the left icon while `loading`. */
...
export function Button(props: Props) {
  ...
  // A disabled (or loading) link can't navigate — render an inert button instead.
  ...
  // Strip link-only and custom props that aren't valid on a native <button>.
